    ...
    if (isset( $_SESSION['userName'])) {
        ...
        if (isset($_POST['man'])) {
            ...
            if ($items12[0]['signature'])
            {
                ...
                {
                    header("Location: ../View/Procurement/compApproveByManD.php?fail= Error:".mysqli_error($conn)); 
                }
            ...
            if ($sigman22)
            {
                ...
                {
                    header("Location: ../View/Procurement/compApproveBySup.php?fail= Error:".mysqli_error($conn)); 
                }
