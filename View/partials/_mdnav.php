          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link size" href= <?php echo($inventory["approveLocationRequest"]) ?>>Product Approval</a></li>
                <li class="nav-item"> <a class="nav-link size" href= <?php echo($inventory["requestView"]) ?>>Request View</a></li>
              </ul>
            </div>
          </li>
<!-- dropdown -->
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic88">
              <ul class="nav flex-column sub-menu">
                ...
                <!--  -->
                <li class="nav-item"> <a class="nav-link size" href="<?php echo $accounts["sd"]?>">Loan/Deductions</a></li>
