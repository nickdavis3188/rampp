<?php
   ...
   if(isset($_SESSION['validuser']))
   {
    ...
    $order =  $UserUtils->getAllBarOrder($conn);
    // print_r($order);
?>
<!-- HEADER -->
<body>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Bar Order</h4>
                </div>
                <!-- <div>
...
<script>
    ...
    function checkItem(orid,input){
        ...
        if (input.checked){
            let mydata = JSON.stringify({"orderId":orid,"prepAt":"Bar"})
