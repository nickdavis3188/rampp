<?php
   ...
   if(isset($_SESSION['validuser']))
   {
     ...
     include("../../Utils/sidebarUtils.php");
      ...
      $data1 = $UserUtils-> payrollTableDisplay($conn);
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">View Payroll</h4>
                </div>
                <!-- <div>
    ...
    let manstat = ()=>{
      ...
      let mandstat = ()=>{
        ...
        if (approve3 == 1) {
            ...
            manDStatus.innerHTML = `<p class="text-danger">Decline</p><br/><p class="text-danger">Managing Director</p><br/><p class="text-danger">${remark3}</p><br/><p class="text-danger">${dateFormat(approveDate3)}</p>`         
        }else{
          if (sgnature3) {
            manDStatus.innerHTML = `<img src="../${sgnature3}" width="100px"/><br/><p class="text-success">Managing Director</p><br/><p class="text-success">${remark3}</p><br/><p class="text-success">${dateFormat(approveDate3)}</p>` 
          } else {
            manDStatus.innerHTML = `<p class="text-success">Approve</p><br/><p class="text-success">Managing Director</p><br/><p class="text-success">${remark3}</p><br/><p class="text-success">${dateFormat(approveDate3)}</p>`   
          }
        }
      }
