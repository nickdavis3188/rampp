          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Debt Report</h4>
                </div>
                <!-- <div>
          ...
          <tbody>
            <?php
               foreach ($data1 as $index => $value) {  
                $stat = "";
                if($value["deptAmount"]== null ||$value["deptAmount"]== 0){
                    $stat = "<label class='badge badge-success'>No Debt</label>";
                }else{
                $stat = "<label class='badge badge-danger'>Debtor</label>";
                }
            ?>
          <tr>
            ...
            <td><?php echo $stat; ?></td>
            <td><?php echo "#".number_format($value["deptAmount"]== null ||$value["deptAmount"]== 0?0:$value["deptAmount"],2,".",",") ?></td>
            <td>
            <div class="dropdown ">
              <div class="d-flex justify-content-between align-items-center">
