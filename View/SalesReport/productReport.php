          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Product Sales Report</h4>
                </div>
            ...
            <form >
                ...
                <div class="form-group row">
                    ...
                    <label for="exampleFormControlSelect1">Select Product</label>
                      <select name="pname" class="form-control form-control-lg pname" id="exampleFormControlSelect1" >
                        <?php
...
function addItem(btn) {
  ...
  if(dtt.value == "" || dtf.value == "" || pname.value == ""){
    alert("please confirm your input")  
      ...
      //  console.log("I AM CLICKED",orid,uid)
       ...
       let mydata = JSON.stringify({ "dateFrom":dtf.value,"dateTo":dtt.value,"pId":pname.value})
       fetch("../../Utils/productReportUtils.php",{
           method: 'POST',
           body: mydata,
