          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Monthly Sales Report</h4>
                </div>
...
alert("please confirm your input")  
  ...
  //  console.log("I AM CLICKED",orid,uid)
   ...
   let mydata = JSON.stringify({ "month":mnt.value,"year":yer.value})
   fetch("../../Utils/monthlyUtils.php",{
       method: 'POST',
       body: mydata,
