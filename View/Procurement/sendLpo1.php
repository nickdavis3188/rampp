              ...
              <div class="" >
                <div class="">
                  ...
                  <!-- <form class="forms-sample" action="../../Controller/vendorController.php" method="post"> -->
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <button name="vendor" type="submit" class="btn btn-primary me-2 btn-block  " style="background:#02679a;color:white;" onClick="loading22(this)">Get Vendors For This Requisition</button>
                          </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                    ...
                    <button id="mq" name="vendor" type="submit" class="btn btn-primary me-2  btn-block " style="background:#02679a;color:white;" onClick="loading11(this)" disabled>Select Vendor For (LPO)</button>
...
<script>
 ...
 function loading11(par) {
    ...
    par.innerText = "Creating Templates For mail...";
    let newSpan = document.createElement("span");
    newSpan.classList.add("spinner-border");
    newSpan.classList.add("spinner-border-sm");
    ...
    window.location = window.location.origin+"/rampp/View/Procurement/sendLpoToVendor.php?id="+ele3.value+"&reqno="+reqno1.value;
