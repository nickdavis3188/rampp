                      ...
                      <div class="form-group row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input readonly name="lpono" type="text" class="form-control Lno" id="exampleInputUsername1" value="<?php echo $UserUtils->getLpoN($conn); ?>">
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="exampleInputUsername1">RegNo</label>
                            <input readonly name="reqno" type="text" class="form-control Rno" id="exampleInputUsername1" value="<?php echo $_REQUEST["reqno"] ?>" disabled>
                          </div>
                        </div>
                      </div>
    ...
    <script>
      ...
      function changeVat(params) {
        ...
        if (params.value == "Yes") {
          ...
          let discountValue = document.querySelector(".descval").value
          let totalvalue = subtotalValue - discountValue
          let fivePercentAdded = (7.5 / 100) * totalvalue
          vatvalue.value = fivePercentAdded

          let added = totalvalue + fivePercentAdded
          ...
          let discountValue = document.querySelector(".descval").value
          let totalvalue = subtotalValue - discountValue
          let fivePercentAdded = 0
          vatvalue.value = fivePercentAdded
          let added = totalvalue
          grandTotal.setAttribute("ammount", added)
          grandTotal.innerHTML = "#" + added.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')
        }
      }
      ...
      function loading11(par) {
        ...
        fetch("../../Controller/lpoController.php", {
          ...
          if (data.status == "success") {
            window.location = window.location.origin + "/View/Procurement/lpocreate.php?msg=" + data.message;
          } else {
            window.location = window.location.origin + "/View/Procurement/lpocreate.php?fail=" + data.message;
          }
        })
