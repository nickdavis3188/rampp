<?php
   ...
   if(isset($_SESSION['validuser']))
   {
     ...
     $data = $UserUtils-> getAllApprovedByMdk($conn);
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Select Vendor For Quote</h4>
                </div>
                <!-- <div>
...
<script>
 ...
 function loading11(par) {
    ...
    par.innerText = "Creating Quote Template...";
    let newSpan = document.createElement("span");
    newSpan.classList.add("spinner-border");
    newSpan.classList.add("spinner-border-sm");
    ...
    window.location = window.location.origin+"/Rampp/View/Procurement/makeQuote.php?id="+ele3.value+"&reqno="+reqno1.value;
