      ...
      <div class="main-panel">
        <div class="content-wrapper gbgn">
          ...
          <div class="container-flued">
              ...
              <table class="table"  >
                  ...
                  <tr>
                      ...
                      <td>
                          <table class="table">
                              <tr>
                                  <td class="td">Unit Price</th>
                                  <td class="td">Total</th>
                                  <td class="td">Vendor</th>
                              </tr>
            ...
            <div class="row">
              <div class="col-4">
                  <div class="sups text-center" style="line-height: 9px;font-size: xx-small;">
                      <p class="text-info">Pending</p>
                      <p class="text-info">Supervisor</p>
                  </div>  
              </div>
              <div class="col-4">
                <div class="mns text-center" style="line-height: 9px;font-size: xx-small;">
                  <p class="text-info">Pending</p>
                  <p class="text-info">Manager</p>
                </div>   
              </div>
              <div class="col-4">
                <div class="mnds text-center" style="line-height: 9px;font-size: xx-small;">
                  <p class="text-info">Pending</p>
