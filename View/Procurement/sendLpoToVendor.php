          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Send LPO</h4>
                </div>
                <!-- <div>
         ...
         <div class="row">
            <div class="col-12 grid-margin ">
              <div class="" >
                ...
                <form class="forms-sample" action="../../Controller/sendLpoController.php" method="post" enctype="multipart/form-data">
                        <?php
                            $id = (isset($_REQUEST["id"])) ? $_REQUEST["id"] :"";
                            $reqno = (isset($_REQUEST["reqno"])) ? $_REQUEST["reqno"] :"";
                        ?>
                    <div class="form-group row">
                    <input name="vid" class="form-control" type="hidden" value="<?php echo $id ?>" >
                    <input name="pid" class="form-control" type="hidden" value="<?php echo $reqno ?>">
                    <div class="col-sm-6">
                            <div class="mb-3 form-group">
                              <label for="formFile" class="form-label">Send Pdf</label>
                              <input name="lpo" class="form-control fil" type="file" id="formFile"style="background:#02679a;color:white;" required>
                            </div>    
                        </div>  
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="exampleInputUsername1" class="tlt"></label>
                                <div class="sel">
                    ...
                    <button id="mq" name="send" type="submit" class="btn btn-primary me-2  btn-block " style="background:#02679a;color:white;" onClick="loading11(this)">Send Mail</button>
...
<script>
          ...
          console.log("response",data)
                ...
                if(data.length >= 1){
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        ptn.value = data[i].vendorId
                        ptn.innerText = data[i].venname
 ...
 function loading11(par) {
    ...
    if (fil.files.length > 0) {
      ...
      // window.location = window.location.origin+"/View/Procurement/createLpo.php?id="+ele3.value+"&reqno="+reqno1.value;
